...
const (
	...
	compressDef   = Dm_build_335
	compressIDDef = Dm_build_336
...
func (c *DmConnector) setAttributes(props *Properties) error {
	...
	c.bufPrefetch = props.GetInt(BufPrefetchKey, c.bufPrefetch, int(Dm_build_320), int(Dm_build_321))
